...
Try {
    ...
    [String]$appName = 'Forti Client VPN'
    [String]$appVersion = '7.4.3.1790'
    [String]$appArch = 'x64'
    [String]$appLang = 'EN'
    [String]$appRevision = '01'
    [String]$appScriptVersion = '1.0.0'
    [String]$appScriptDate = '02.04.2025'
    [String]$appScriptAuthor = 'chuck8diesel'
    ##*===============================================
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        execute-MSI -Action Install -Path "FortiClientVPN.msi" -addparameters "INSTALLLEVEL=1"
        ...
        Execute-Process -Path "$envprogramfiles\Fortinet\FortiClient\FCConfig.exe" -Parameters " -m vpn -f $dirsupportfiles\config.xml -o import -p Start#1234"
...
If ($registryApp) {
    $guid = ($registryApp.UninstallString -replace ".*\{(.+?)\}.*", '$1')
...
elseif (Test-Path "$envProgramFiles\Fortinet\FortiClient\uninst.exe") {
    ...
    ElseIf ($deploymentType -ieq 'Repair') {
        ...
        Execute-MSI -Action Repair -Path $msiPath
